...
export DEV_DATABASE_URI="${DEV_DATABASE_URI:-postgresql://assistencias_dev:assistencias_dev@localhost:5432/assistencias_dev}"
export TEST_DATABASE_URI="${TEST_DATABASE_URI:-postgresql://assistencias_test:assistencias_test@localhost:5432/assistencias_test}"
